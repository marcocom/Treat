...
//            $(window).bind('scroll', this.onScroll);
        ...
        parallaxScroll : function(){// Scroll the background layers
...
//            });
    ...
    if($('.hair-content').length > 0) this.hairContent = new $t.Page.Hair('.hair-content');
    if($('.health-content').length > 0) this.healthContent = new $t.Page.Health('.health-content');
